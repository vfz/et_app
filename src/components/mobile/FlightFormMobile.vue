                        ...
                        <div>
                          ...
                          <div v-bind:class="{'d-flex': isShow, 'd-none': !isShow}" class="passengers-count-detail justify-content-between w-100">
                            <div class="count-passenger d-flex align-items-center flex-wrap">
                              <div id="minus-button-adult" class="minus-button count-button" :class=" { disabled : !mba } " v-on:click="MinusAdult();changeClass();removePassenger(true);">-</div>
                            ...
                            <div class="count-passenger d-flex">
                              <div class="d-flex align-items-center flex-wrap">
                                <div id="minus-button-childeren" class="minus-button count-button" :class=" { disabled : !mbc } " v-on:click="MinusChild();changeClass();removePassenger(false);">-</div>
